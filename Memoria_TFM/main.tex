...
\newcommand{\nombretutor}{Itziar Uzqueda Esteban}
\newcommand{\nombretrabajo}{Desarrollo de un sensor de ultrasonidos para la valoración ambulatoria de la marcha}
\newcommand{\fecha}{Junio de 2017}
