...
%	\end{itemize}
 ...
 \end{figure} 
  ...
  Dependiendo de la relación de diámetro entre el núcleo y el revestimiento, la fibra fibra será monomodo o multimodo (figura \ref{fig:modoMonoMulti}). Esta diferencia afecta a la propagación de la luz dentro de la guía de onda. 
 
 
 La diferencia de índices de refracción entre las capas centrales de la fibra son las que permiten la propagación de la luz a través de esta.
 


  
 //Centrándonos en las capas por las cuales se propaga la luz, el núcleo y el revestimiento y en su funcionamiento como guía de onda.
...
La más interna corresponde al núcleo. Típicamente fabricado a base de sílice, y que destaca por su alto índice de refracción. 

Rodeando al núcleo se encuentra la cubierta, de material similar, pero con un
índice de refracción menor. 

Esta diferencia de índices de refracción es el fundamento físico que permite la propagación de la luz entre ambas capas a través del filamento de fibra óptica.
