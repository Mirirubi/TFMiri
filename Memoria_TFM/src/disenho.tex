...
%--	\item \textbf{Redes de difracción de Bragg \textit{(FBG - Fiber Bragg Grating)}}\\	
	...
	\item \textbf{Sensores de ópticos}\\
	...
	\begin{itemize}
		...
		A partir de estos conocimientos se deduce cómo, cuando se genere una deformación de la fibra a la altura de la rejilla de Bragg		
...
------------------------------------------------------
		...
		posibilidad de ponerlo en serie
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.75\textwidth]{./img/reflexBragg}
		\caption{Representación esquemática de la reflexión de una frecuencia determinada de la luz viajando en la fibra óptica en una red de Braggs. \cite{tesisUPMmalte}} 
		\label{fig:reflexBragg}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.75\textwidth]{./img/medicBragg2}
		\caption{asdffdsfdsf. \cite{FOSensorFrancis}} 
		\label{fig:reflexBragg2}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.75\textwidth]{./img/medicBragg}
