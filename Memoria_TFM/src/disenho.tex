...
%	\end{itemize}
	...
	\end{table}
	 ...
	 \begin{figure}[H]
	 	...
	 	\caption{Longitud de onda fibra óptica junto con el espectro visible}
	 	\label{fig:ventanaOptica}
	 \end{figure}
 
 En cuanto a las propiedades físicas de la fibra mayormente se obtienen de la extrusión del sílice. El grosor de las fibras ópticas no supera  por mucho al diámetro del cabello humano.
