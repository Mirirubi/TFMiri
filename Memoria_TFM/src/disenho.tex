...
%--FIBRA ÓPTICA
	...
	La fibra óptica es una hebra de material dieléctrico, así cómo vidrio (sílice) o polímeros acrílicos. 
	Se emplea como medio de propagación de señales luminosas, es decir, para transmitir ondas electromagnéticas del espectro óptico. 
...
La fibra óptica es un medio de transmisión de señal luminosa. Concretamente, es una guía de
ondas electromagnéticas constituida de material dieléctrico, como el vidrio (sílice), capaz de
propagar ondas electromagnéticas en el rango del ultravioleta-visible al visible-infrarrojo de
uno a otro de sus extremos.
