...
Molde guante??? \textcolor{rositaoscuro}{Esto no voy a ponerlo aquí puesto que ya es un instrumento fabricado por nosotros}. 

Para la fabricación del guante de PDMS se han empleado herramientas qu ha simple vista pueden parecer de aplicación tan dispares como una báscula, un horno y una empalmadora de fibra (ver figura \ref{fig:herramientas}; \ref{fig:empalmadora}). La báscula utilizada es la disponible en el laboratorio de la universidad tiene ua precisión de miligramos y en este proyecto se utiliza para utilizar con exactitud la proporción del monómero y el agente de cura en la disolución de PDMS. El horno se emplea para conseguir que el PDMS se cure con ayuda del calor en menos tiempo.
...
\end{figure}
	...
	La base de la fabricación del guante es la mezcla a realizar para la obtención de la densidad del PDMS requerida. Si se toma una disolución muy diluida el guante será demasiado  
	
	hace falta mezclar blablabla y blavla
	...
	\begin{enumerate}
		\item Preparar mezcla PDMS (55g de polímero y 5.5g de agente de curación). Primero el
