...
% _ Montaje completo:	
	...
	Estas uniones se colocan en la caja (ver figura \ref{fig:CajaOrden}. Por un extremo de la caja se insertan las seis fibras monomodo al primer apartamento, almacena el cableado sobrante en el segundo apartamento se colocan las conexiones al splitter. 

	
	Se han etiquetado debidamente todas las fibras para una mejor organización.
	
	
	\item \underline{Colocación en la caja}
	
	
	
	
	
	\item \underline{Conexión de la fuente}
	
	
	
	
	
	\item \underline{Conexión del interrogador}
